...
$query = mysqli_query($con, "select * from orders where id= '$orderid'");
$getOrderDetails = mysqli_fetch_array($query);

$salesPersonQuery = mysqli_query($con, "select * from users where id = '{$getOrderDetails['salesperson_id']}'");
$salesPersonDetails = mysqli_fetch_array($salesPersonQuery);

$customerQuery = mysqli_query($con, "select * from users where id = '{$getOrderDetails['customer_id']}'");
$customerDetails = mysqli_fetch_array($customerQuery);
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                             <div class="well">
                                 <h4>Sales Person : </h4>
                                 <label><?php echo $salesPersonDetails['name']; ?></label>
                                 <br/>
                                 <h4>Customer : </h4>
                                 <label><?php echo $customerDetails['name']; ?></label>
                                 <br/>
                                 <h4>Amount in KSh : </h4>
                                 <label><?php echo $getOrderDetails['amount']; ?></label>
                                 <br/>
                             </div>
                            <label>Products Ordered</label>
                               <div>
                                   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                       ...
                                       $query = mysqli_query($con, "select * from orders_line_item where order_id = '{$getOrderDetails['id']}'");
