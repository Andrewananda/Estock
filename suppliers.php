                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if ($_SESSION['user_type'] == "admin") {
                                    ?>
                                    <a href="add-supplier.php" class="btn btn-primary btn-sm pull-right add-btn"><i class="fa fa-plus"></i> Add New</a>                                                class="fa fa-plus"></i> Add New</a>
                                    <?php
                                }
                                ?>
                            </div>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                if ($row['status'] == "1") {
                                                    ...
                                                    echo " <span class=\"btn btn-danger\">Deactivated</span>";
                                                }
                                                ?>
                                            </td>
                                            <td class="center">
                                            ...
                                            <td class="center">
                                                <a href="supplier.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-primary btn-sm">View</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
