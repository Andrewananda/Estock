...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Sales People</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if ($_SESSION['user_type'] == "admin") {
                                    ?>
                                    <a href="add-salesperson.php" class="btn btn-primary btn-sm pull-right add-btn"><i
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <table width="100%" class="table table-striped table-bordered table-hover"
                                    ...
                                    <tbody>
                                    <?php
                                    $query = mysqli_query($con, "select * from users where user_type='salesperson'");
