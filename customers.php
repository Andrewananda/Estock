            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-md-12">
                                <a href="add-customer.php" class="btn btn-primary btn-sm pull-right add-btn"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                        </div>
                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    while ($row = mysqli_fetch_array($query, MYSQLI_ASSOC)) {
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                <a href="customer.php?id=<?php echo $row['id']; ?>"><button type="button" class="btn btn-primary btn-sm">View</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
