...
$productId = $_GET['id'];
$query = mysqli_query($con, "select * from users where id= '$customerId'");
$getCustomerDetails = mysqli_fetch_array($query);
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="well">
                                    <h4>Name : </h4>
                                    <label><?php echo $getCustomerDetails['name']; ?></label>
                                    <br/>
                                    <h4>Email : </h4>
                                    <label><?php echo $getCustomerDetails['email']; ?></label>
                                    <br/>
                                    <h4>Address : </h4>
                                    <label><?php echo $getCustomerDetails['address']; ?></label>
                                    <br/>
                                    <h4>Status : </h4>
                                    <label>
                                        <?php
                                        if ($getCustomerDetails['status'] == "1") {
                                            echo " <span class=\"badge badge-default badge-success\">Active</span>";
                                        } else {
                                            echo " <span class=\"badge badge-default badge-danger\">Deactivated</span>";
                                        }
                                        ?>
                                    </label>
                                    <br/>
