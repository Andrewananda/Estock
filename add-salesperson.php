...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into `users` (`name`,`email`,`password`,`address`,`status`,`user_type`,`created_at`)"
        . " values('$name','$email','$pass','$address','1','salesperson','$currentTime')");

    if ($query){
        $message = "Salesperson has been added";
    }else{
        $message = "Sorry salesperson has not been added. Try again";
    }
}
?>
...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">Add Salesperson</h3>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="modal-header">
                                                ...
                                                <form class="form" action="add-salesperson.php" method="POST">
