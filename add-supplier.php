...
if (isset($_POST['submit'])) {
    ...
    $query = mysqli_query($con, "insert into `suppliers` (`name`,`status`,`created_at`)"
        . " values('$name','$status','$currentTime')");

    if ($query){
        $message = "Supplier has been added";
    }else{
        $message = "Sorry supplier has not been added. Try again";
    }
}
?>
                                    ...
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="modal-header">
                                                ...
                                                <form class="form" action="add-supplier.php" method="POST">
